...
public class CreateOrganizationWithPhoneNoTest {
	@Test
	public void creatingOrganizationwithPhoneNo() throws IOException, InterruptedException {
		...
		String orgName = wb.getSheet("Organization").getRow(7).getCell(2).toString()+randomInt;
		String phoneNo = wb.getSheet("Organization").getRow(7).getCell(3).toString();
		...
		String phno = driver.findElement(By.xpath("//span[@id='dtlview_Phone']")).getText();
