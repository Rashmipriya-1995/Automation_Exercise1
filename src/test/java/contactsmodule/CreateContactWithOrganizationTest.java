...
public class CreateContactWithOrganizationTest {
	...
	public void creatingContact() throws IOException, InterruptedException {
		...
		String orgName = wb.getSheet("Sheet1").getRow(1).getCell(3).toString()+randomInt;
		...
		String organizationName = driver.findElement(By.id("mouseArea_Organization Name")).getText();
